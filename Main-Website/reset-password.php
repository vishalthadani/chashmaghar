	...
	<div class="container-contact100">
				...
				<table width="100%" >
                   ...
                   <br><br>
                    ...
                    <div class="wrap-input100 validate-input">
						...
						<input class="input100"  placeholder="Enter Your Old Password" type="password" name="opswd" id="opswd"><!--Password-->
						<span class="focus-input100"></span>
					</div>
                    <br>
               		<div class="wrap-input100 validate-input">
        ...
        <script>
			...
			rules: {
					...
					maxlength: "Invalid Password! Password must be less than 15 characters."
				},
                            pswd: {
