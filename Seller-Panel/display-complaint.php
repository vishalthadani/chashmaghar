...
echo "<td>{$userrow['user_name']}</td>";
                                        ...
                                        //echo "<td> <a href='resolve-complaint.php?rid={$comprow['complaint_id']}'><img style='width:20px;' src='images/resolve.png'>Resolve</a> | <a href='display-complaint.php?iid={$comprow['complaint_id']}'><img style='width:20px;' src='images/ignore.png'>Ignore</a></td>";
