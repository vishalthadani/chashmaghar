                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <!--<th>Seller ID</th>--><!-- //Uncomment this line to display seller id in Tbl-->

<!--<th>Status Action</th>--><!-- //Uncomment this line to display Status Actionin Tbl-->
                                        <th>Action</th>
                                    </tr> 
                                </thead>
                                <tbody>
...
//                                        $category_row = mysqli_fetch_array($select1);
                                        ...
                                        // echo "<td>{$productrow['product_img1']}</td>";
                                        // echo "<td>{$productrow['product_img2']}</td>";
                                        // echo "<td>{$productrow['product_img3']}</td>";
                                        ...
                                        //echo "<td>{$productrow['seller_id']}</td>";  //Uncomment this line to display seller id in Tbl
                                        // echo "<td>{$productrow['product_is']}</td>";
                                        // echo "<td>{$productrow['product_name']}</td>";
                                        ...
                                        // {
                                        //     echo "<td>Unhidden</td>";
                                        // } //<!-- //Uncomment this Abiove code from if statement to display Status Actionin Tbl-->
                                        //HIDE UNHIDEecho "<td> <a href='display-category.php?hid={$productrow['category_id']}'><img style='width:25px;' src='images/hide-icon.png'>Hide</a> | <a href='display-category.php?uhid={$productrow['category_id']}'><img style='width:25px;' src='images/unhide-icon.png'>Unhide</a></td>";
                                        echo "<td> <a class='label label-info' style='font-size:100% !important;font-weight: 300 !important;' href='editproductdet.php?eid={$productrow['product_id']}'><i class='fa fa-pencil'></i> Edit</a>"; //DELETE ICOn   | <a href='display-category.php?did={$productrow['category_id']}'><img style='width:25px;' src='images/delete-icon.png'>Delete</a></td>
                                        echo "</tr>";
                                    }
                                    ?>
