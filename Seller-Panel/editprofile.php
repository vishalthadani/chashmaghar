...
?>
<?php
$select = mysqli_query($conn, "select * from seller_tbl where seller_id='2'") or die(mysqli_error($conn));
                                ...
                                <div class="form-body">
                                    <form class="form-horizontal" method="post" enctype="multipart/form-data" name="form" id="form"> 
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <div class="col-sm-9"> 
                                                <input type="text" name="usern" class="form-control" id="usern" value="<?php echo $selectrow['seller_name'] ?>" placeholder="Enter Seller Name"> 
                                            </div><br/><br/>

                                            <label for="inputEmail3" class="col-sm-2 control-label">Email ID</label> 
                                            <div class="col-sm-9"> 
                                                <input type="text" name="email" class="form-control" id="email" value="<?php echo $selectrow['seller_email'] ?>" placeholder="Enter Seller Email ID" readonly> 
                                            </div><br/><br/>

                                            <label for="inputEmail3" class="col-sm-2 control-label">Phone No.</label> 
                                            <div class="col-sm-9"> 
                                                <input type="text" name="pn" class="form-control" id="pn" value="<?php echo $selectrow['seller_phone'] ?>" placeholder="Enter Seller Phone Number" onkeyup="validatenumber(this);"> 
                                            </div><br/><br/>
                                            ...
                                            <div class="col-sm-9"> 
                                                <input type="text" name="add1" class="form-control" id="add1" value="<?php echo $selectrow['seller_address1'] ?>" placeholder="Enter Address Line 1"> 
                                            </div><br/><br/>

                                            <label for="inputEmail3" class="col-sm-2 control-label">Address Line 2</label> 
                                            <div class="col-sm-9"> 
                                                <input type="text" name="add2" class="form-control" id="add2" value="<?php echo $selectrow['seller_address2'] ?>" placeholder="Enter Address Line 1"> 
                                            </div><br/><br/>

                                            <label for="inputEmail3" class="col-sm-2 control-label">Pincode</label> 
                                            <div class="col-sm-9"> 
                                                <input type="text" name="pinc" class="form-control" id="pinc" value="<?php echo $selectrow['seller_pincode'] ?>" placeholder="Enter Seller Pincode" onkeyup="validatenumber(this);"> 
                                            </div> <br/><br/>

                                            <label for="inputEmail3" class="col-sm-2 control-label">GSTIN Id</label> 
                                            <div class="col-sm-9"> 
                                                <input type="text" name="gstin" class="form-control" id="gstin" value="<?php echo $selectrow['seller_gstin'] ?>" placeholder="Enter Seller GSTIN" readonly> 
                                            </div><br/><br/>

                                            <label for="inputEmail3" class="col-sm-2 control-label">Authentication Status</label> 
                                            <div class="col-sm-9"> 
                                                <input type="text" name="auth" class="form-control" id="auth" value="<?php if($selectrow['auth_status'] == 1) { echo 'Autheticated';} else{ echo 'Unautheticated';}  ?>" placeholder="Authentication Status" readonly> 
                                            </div><br/><br/>
