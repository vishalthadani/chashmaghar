                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Price</th>
                                        <th>Quantity</th>
                                        <!--<th>Product Status</th>--> <!--UNcomment this to shoe Product status in tbl heading--> 
                                        <!--<th>Status Action</th>-->  <!--UNcomment this to shoe Status Action in tbl heading--> 
                                        <th>Action</th>
                                    </tr> 
                                </thead>
                                <tbody>
                                <p style="text-align:right;"><button class="btn btn-primary" onclick="window.location = 'add-product.php';">Add Product</button></p>
                                <?php
...
//                                    $categoryrow = mysqli_fetch_array($select1);
                                    ...
                                    // {
                                    //     echo "<td>Unhidden</td>";
                                    // }//UNconmment from If statement to show Hide Unhide in tbl rows
                                    ...
                                    echo "<td> <a class='label label-danger' style='font-size:100% !important;font-weight: 300 !important;' href='display-product.php?did={$productrow['product_id']}'><i class='fa fa-trash-o'></i> Delete</a></td>";
                                    echo "</tr>";
                                }
                                ?>
