                                ...
                                <tbody>
                                    ...
                                    while ($feedrow = mysqli_fetch_array($select)) {
                                        ...
                                        if ($feedrow['feedback_status'] == 0) {
                                            echo "<td> <a class='label label-success' style='font-size:100% !important;font-weight: 300 !important;' href='display-feedback.php?uhid={$feedrow['feedback_id']}'><i class='fa fa-eye'></i> Unhide</a> </td>";
                                        } else {
                                            echo "<td> <a class='label label-warning' style='font-size:100% !important;font-weight: 300 !important;' href='display-feedback.php?hid={$feedrow['feedback_id']}'><i class='fa fa-eye-slash'></i> Hide</a> </td>";
                                        }
