...
$select = mysqli_query($conn,"select * from category_tbl where category_id='{$editid}'") or die(mysqli_error($conn));
							...
							<div class="form-body">
								<form class="form-horizontal" method="post" enctype="multipart/form-data"> 
                                                                    ...
                                                                    <div class="form-group"> 
                                                                        ...
                                                                        <div class="col-sm-9"> 
                                                                            <input type="text" name="category" class="form-control" id="inputEmail3" value="<?php echo $selectrow['category_name']?>" placeholder="Enter Category Name" required> 
                                                                        </div> 
                                                                    </div>
                                                                    <div class="col-sm-offset-2"> 
                                                                        <button type="submit" name="submit1" class="btn btn-success">Update Category</button>
